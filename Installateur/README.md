...
4. Exécuter la recette Office U2b : socle Word au moins `34`, extension Word U2 exactement `17/17`, Excel exactement `25/25`.
...
Le même fichier fonctionne sur les trois postes. Utiliser la session Windows habituelle, sans « Exécuter en tant qu'administrateur ». Windows, Word et Excel de bureau sont nécessaires. À domicile, une liaison privée sécurisée doit permettre l'accès au NAS. Le service NAS doit déjà être déployé ; son adresse HTTPS et le secret applicatif propre au compte du poste sont demandés à l'activation.
