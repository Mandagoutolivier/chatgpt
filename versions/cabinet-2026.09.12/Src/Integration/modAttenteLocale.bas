...
Public Sub SynchroniserAttentes()
    Dim dossier As String, f As Variant, d As Object, sql As String, auj As String, result As Object
    Set result = modServiceNas.Appeler("attentes", modServiceNas.Parametres())
    ...
    For Each d In result("items")
        f = CStr(d("ConsultationID"))
