...
Public Function GenererDepuisProfil(ByVal docSource As Document, ByVal p As Object, _
    ...
    Set pat = modApiConfiguration.PatientDuDocument(docSource)
    Set corSource = modApiConfiguration.CorrespondantDuDocument(docSource)
    ...
    reponse = modApiConfiguration.AppelerClaude(systeme, "Patient : " & identite & vbLf & vbLf & _
    ...
    modCourrier.RemplacerCorps nouveauDoc, modApiConfiguration.NettoyerReponse(final)
