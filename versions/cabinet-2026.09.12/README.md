...
**Correctifs ciblés des audits : `2026.09.21-u2c`, destinés à une recette isolée.** Voir [le bilan des corrections et les validations restantes](U2_CORRECTIFS_AUDITS.md). L'installation clinique est conservée. La qualification Office isolée U2c du 21/09/2026 a compilé Word et Excel et validé 359 contrôles sans activation clinique, sans accès NAS et sans impression réelle. Une recette multi-postes sur données fictives reste requise avant toute utilisation avec des patients.
